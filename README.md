...
| **`🔢 UART 제어 Counter-10000 설계 및 검증 프로젝트`** | `UART로 제어되는 Counter를 위한 SystemVerilog 기반의 UART 기능 검증 환경 구축` | `SystemVerilog, Vivado, Basys3` | [![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/eunseong-kim-01/) |
